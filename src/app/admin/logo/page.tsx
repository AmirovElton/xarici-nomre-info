        ...
        {logoType === 'url' ? (
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-zinc-800 border border-zinc-700 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
            />
        ...
        {logoUrl && logoType === 'url' && (
          <div className="mt-6 p-4 bg-zinc-800/50 rounded-xl border border-zinc-700">
            ...
            <div className="flex items-center gap-3">
              <img src={logoUrl} alt="Logo preview" className="w-10 h-10 rounded-xl object-contain bg-zinc-900 p-1" />
              <span className="font-bold">
                <span className="text-indigo-400">XariciNomrə</span>
