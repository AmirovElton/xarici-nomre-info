...
export default function WhatsAppFloating() {
  ...
  const msg = settings?.default_whatsapp_message || 'Salam, XariciNomrəAz saytından gəlirəm. Xarici nömrə haqqında məlumat almaq istəyirəm.'
  return (
    <a
      href={getWhatsAppUrl(whatsapp, msg)}
      target="_blank"
