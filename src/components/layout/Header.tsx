        ...
        <nav className="glass-nav rounded-2xl px-4 py-3 md:px-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl hover:bg-gray-800/50 transition-colors text-gray-300"
            >
          ...
          {/* Mobile Menu */}
          {isOpen && (
            <div className="md:hidden mt-3 pt-3 border-t border-gray-700/50 animate-fade-in">
