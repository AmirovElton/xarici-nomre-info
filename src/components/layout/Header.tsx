          ...
          <nav className="glass-nav rounded-2xl px-4 py-3 md:px-6">
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-1">
                {navItems.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                    className="px-4 py-2 rounded-xl text-sm font-medium text-gray-300 hover:text-indigo-400 hover:bg-indigo-500/10 transition-all"
                  >
                    {item.label}
                  </Link>
                ))}
              ...
              <button
                ...
                className="md:hidden p-2 rounded-xl hover:bg-zinc-800/50 transition-colors text-gray-300"
              >
                ...
                <div className="flex flex-col gap-1">
                  {navItems.map((item) => (
                    <Link
                      ...
                      className="px-4 py-3 rounded-xl text-sm font-medium text-gray-300 hover:text-indigo-400 hover:bg-indigo-500/10 transition-all"
                    >
                      {item.label}
                    </Link>
                  ))}
