  ...
  return (
    <section className="px-4 py-12">
      <div className="max-w-3xl mx-auto">
        <div className="theme-card p-8 md:p-12 text-center relative overflow-hidden">
          {/* Glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 rounded-full blur-3xl -z-10" style={{ background: 'rgba(34,197,94,0.08)' }} />

          <div className="w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #22c55e, #16a34a)', boxShadow: '0 4px 20px rgba(34,197,94,0.3)' }}>
          ...
          <p className="text-xs mt-4" style={{ color: 'var(--text-faint)' }}>İş saatları: 09:00 - 22:00</p>
        </div>
      </div>
    </section>
  )
